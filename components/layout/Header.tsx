    ...
    <>
        ...
        <nav className="container-responsive">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button className="hidden md:block p-2 rounded-lg glass-button">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute top-0 right-0 h-full w-80 max-w-sm glass-card border-l border-white/20 animation-slide-up">
